...
import 'dao/bookmarked_episodes_dao.dart';
...
@DriftDatabase(tables: [Podcasts, PlayedHistoryEpisodes, Episodes, BookmarkedEpisodes], daos: [PodcastsDao, PlayedHistoryEpisodesDao, EpisodesDao, BookmarkedEpisodesDao])
  ...
  MigrationStrategy get migration {
    return MigrationStrategy(
      ...
      onUpgrade: (Migrator m, int from, int to) async {
        ...
        //}
        // Add other migration steps for Future<void> versions here
        // if (from < 3) {
